...
export const DATA = {
  name: "Tathagat Harsh",
  initials: "TH",
  url: "https://www.linkedin.com/in/tathagatharsh",
  location: "Sonipat, Haryana",
  locationLink: "https://www.google.com/maps/place/Sonipat,+Haryana",
  description:
    "Frontend developer passionate about building intuitive web experiences and solving real-world problems with code.",
  summary:
    "I'm currently pursuing a B.Tech in Artificial Intelligence at Newton School of Technology, Rishihood University. I've solved 100+ LeetCode problems, built several interactive projects, and have a solid foundation in DSA. I've developed applications like the Bankist App and Guess the Number Game using HTML, CSS, and JavaScript. I'm actively building and learning in public through platforms like GitHub and LinkedIn.",
  avatarUrl: "/pic.jpeg",
  skills: ["HTML", "CSS", "JavaScript", "React", "Python", "Pandas"],
  navbar: [
  ...
  contact: {
    email: "tathagat.harsh2024@nst.rishihood.edu.in",
    tel: "+919910212094",
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/tathagatharsh",
        icon: Icons.github,
        navbar: true,
      },
      LinkedIn: {
      ...
      LeetCode: {
        ...
        icon: Icons.leetcode, // Make sure this icon exists or define it
        navbar: true,
      },
      email: {
        name: "Send Email",
        url: "mailto:tathagat.harsh2024@nst.rishihood.edu.in",
        icon: Icons.email,
        navbar: false,
      },
      X: {
        name: "X (Twitter)",
        url: "https://twitter.com/tathagatharsh", // replace with your actual handle if different
        icon: Icons.x, // make sure Icons.x exists or import the icon (like from lucide-react or react-icons)
        navbar: true,
      },
    },
  },
  ...
  projects: [
    ...
    },
    {
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/TathagatHarsh/BankistApp",
          icon: <Icons.github className="size-3" />,
        },
      ],
      image: "",
